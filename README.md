...
Done so far:
Access Rigts:
Created four users: HR, Reveiwer, Supervisor, Employee
Must assign HR manually
If you are assigned as a manager/secondary manager for an employee then the user is granted access rights of Supervisor #Note: Supervisor and Secondary Supervisor has the same access rights
