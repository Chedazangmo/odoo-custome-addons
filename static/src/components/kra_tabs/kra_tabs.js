...
class KpiHistoryDialog extends Component {  // New
    static template = "hr_employee_evaluation.KpiHistoryDialog";  // New
    static components = { Dialog };  // New
    static props = {  // New
        close: Function,  // New
        kpiName: String,  // New
        kpiData: Object,  // New
        hasSecondary: { type: Boolean, optional: true },  // New
    };  // New
}
...
export class KraTabs extends Component {
    ...
    get activeTotalScore() {
        ...
        onViewKpiHistory(kpiRecord) {  // New
        this.dialog.add(KpiHistoryDialog, {  // New
            kpiName: kpiRecord.data.name || '',  // New
            kpiData: kpiRecord.data,  // New
            hasSecondary: !!this.props.record.data.secondary_supervisor_id,  // New
        });  // New
    } 
